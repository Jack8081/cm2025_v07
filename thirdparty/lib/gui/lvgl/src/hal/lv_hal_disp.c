...
{
    LV_STRACE_VOID(LV_STRACE_ID_DISP_REGISTER);
    ...
    LV_STRACE_CALL_U32(LV_STRACE_ID_DISP_REGISTER, (uint32_t)disp);
...
{
    LV_STRACE_U32(LV_STRACE_ID_DISP_REMOVE, (uint32_t)disp);
    ...
    LV_STRACE_CALL(LV_STRACE_ID_DISP_REMOVE);
}
