...
#define CF_BUILT_IN_LAST LV_IMG_CF_ALPHA_1BIT_LE
...
lv_res_t lv_img_decoder_built_in_open(lv_img_decoder_t * decoder, lv_img_decoder_dsc_t * dsc)
{
    ...
    if(cf == LV_IMG_CF_TRUE_COLOR || cf == LV_IMG_CF_ARGB_8888 || cf == LV_IMG_CF_ARGB_6666 ||
       cf == LV_IMG_CF_TRUE_COLOR_ALPHA || cf == LV_IMG_CF_TRUE_COLOR_CHROMA_KEYED) {
    ...
    /*Alpha indexed images.*/
            ...
            cf == LV_IMG_CF_ALPHA_8BIT || cf == LV_IMG_CF_ALPHA_1BIT_LE || cf == LV_IMG_CF_ALPHA_4BIT_LE) {
                                           ...
                                           lv_coord_t y, lv_coord_t len, uint8_t * buf)
{
    ...
    if(dsc->header.cf == LV_IMG_CF_TRUE_COLOR || dsc->header.cf == LV_IMG_CF_ARGB_8888 ||
       dsc->header.cf == LV_IMG_CF_ARGB_6666 || dsc->header.cf == LV_IMG_CF_TRUE_COLOR_ALPHA ||
       dsc->header.cf == LV_IMG_CF_TRUE_COLOR_CHROMA_KEYED) {
        ...
        if(dsc->src_type == LV_IMG_SRC_FILE) {
            ...
            dsc->header.cf == LV_IMG_CF_ALPHA_1BIT_LE || dsc->header.cf == LV_IMG_CF_ALPHA_4BIT_LE) {
...
#error "Invalid LV_COLOR_DEPTH. Check it in lv_conf.h"
    ...
    if (dsc->header.cf == LV_IMG_CF_ALPHA_4BIT_LE || dsc->header.cf == LV_IMG_CF_ALPHA_1BIT_LE) {
        for(i = 0; i < len; i++) {
