...
enum {
    ...
    LV_IMG_CF_ARGB_8888,               /**< User holder encoding format.*/
    LV_IMG_CF_ARGB_6666,               /**< User holder encoding format.*/
    LV_IMG_CF_ALPHA_4BIT_LE,           /**< User holder encoding format.*/
    LV_IMG_CF_ALPHA_1BIT_LE,           /**< User holder encoding format.*/
