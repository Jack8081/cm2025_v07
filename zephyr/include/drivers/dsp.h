...
struct dsp_bootargs {
	...
	uint16_t dsp_clk_source; /*1-HOSC,2-COREPLL,3-RC64M,4-RC128M*/
	uint16_t dsp_max_freq_mhz;
#endif
};
...
/* 31~28bits of parameter for DSP_EVENT_NEW_DATA  */
enum dsp_msg_data_type {
	DSP_DATA_TYPE_NULL = 0,
	DSP_DATA_TYPE_ENCODE,
	DSP_DATA_TYPE_DECODE,
	DSP_DATA_TYPE_PREDEAL,
	DSP_DATA_TYPE_POSTDEAL,
};
