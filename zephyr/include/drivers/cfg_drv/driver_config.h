...
#define ITEM_ONOFF_PULLR_SEL	      ((ONOFF_DRV_ID<<16) | 10)
...
#define ITEM_AUDIO_ENABLE_VMIC	((AUDIO_DRV_ID<<16) | 21)
#define ITEM_AUDIO_HW_AEC_SELECT	((AUDIO_DRV_ID<<16) | 22)

#define ITEM_AUDIO_MAIN_MIC	      ((AUDIO_DRV_ID<<16) | 23)
#define ITEM_AUDIO_SUB_MIC	      ((AUDIO_DRV_ID<<16) | 24)
#define ITEM_AUDIO_ANC_FF_MIC	  ((AUDIO_DRV_ID<<16) | 25)
#define ITEM_AUDIO_ANC_FB_MIC	  ((AUDIO_DRV_ID<<16) | 26)
#define ITEM_AUDIO_ADC0_INPUT	  ((AUDIO_DRV_ID<<16) | 27)
#define ITEM_AUDIO_ADC1_INPUT	  ((AUDIO_DRV_ID<<16) | 28)
#define ITEM_AUDIO_ADC2_INPUT	  ((AUDIO_DRV_ID<<16) | 29)
#define ITEM_AUDIO_ADC3_INPUT	  ((AUDIO_DRV_ID<<16) | 30)

#define ITEM_AUDIO_ADC0_SEL_VMIC	  ((AUDIO_DRV_ID<<16) | 31)
#define ITEM_AUDIO_ADC1_SEL_VMIC	  ((AUDIO_DRV_ID<<16) | 32)
#define ITEM_AUDIO_ADC2_SEL_VMIC	  ((AUDIO_DRV_ID<<16) | 33)

#define ITEM_AUDIO_PA_GAIN	((AUDIO_DRV_ID<<16) | 34)
#define ITEM_AUDIO_ANALOG_GAIN_SETTINGS	((AUDIO_DRV_ID<<16) | 35)
#define ITEM_AUDIO_ANC_FF_GAIN_SETTING	((AUDIO_DRV_ID<<16) | 36)
#define ITEM_AUDIO_ANC_FB_GAIN_SETTING	((AUDIO_DRV_ID<<16) | 37)

#define ITEM_AUDIO_MAIN_MIC_AAL_ENABLE	  ((AUDIO_DRV_ID<<16) | 38)
#define ITEM_AUDIO_SUB_MIC_AAL_ENABLE	  ((AUDIO_DRV_ID<<16) | 39)
#define ITEM_AUDIO_FF_AAL_ENABLE	  ((AUDIO_DRV_ID<<16) | 40)
#define ITEM_AUDIO_FB_AAL_ENABLE	  ((AUDIO_DRV_ID<<16) | 42)
#define ITEM_AUDIO_MAIN_MIC_AAL_VT1	  ((AUDIO_DRV_ID<<16) | 43)
#define ITEM_AUDIO_MAIN_MIC_AAL_VT0	  ((AUDIO_DRV_ID<<16) | 44)
#define ITEM_AUDIO_ANC_FF_AAL_VT1	  ((AUDIO_DRV_ID<<16) | 45)
#define ITEM_AUDIO_ANC_FF_AAL_VT0	  ((AUDIO_DRV_ID<<16) | 46)
#define ITEM_AUDIO_ANC_FB_AAL_VT1	  ((AUDIO_DRV_ID<<16) | 47)
#define ITEM_AUDIO_ANC_FB_AAL_VT0	  ((AUDIO_DRV_ID<<16) | 48)
...
#else
#define ITEM_CHARGE_INIT_CHARGE_ENABLE ((CHARGE_DRV_ID<<16) | 7)
#define ITEM_CHARGE_INIT_CHARGE_CURRENT1 ((CHARGE_DRV_ID<<16) | 8)
#define ITEM_CHARGE_INIT_CHARGE_VOLTAGE1 ((CHARGE_DRV_ID<<16) | 9)
#define ITEM_CHARGE_INIT_CHARGE_CURRENT2 ((CHARGE_DRV_ID<<16) | 10)
#define ITEM_CHARGE_INIT_CHARGE_VOLTAGE2 ((CHARGE_DRV_ID<<16) | 11)
#define ITEM_CHARGE_INIT_CHARGE_CURRENT3 ((CHARGE_DRV_ID<<16) | 12)
#define ITEM_CHARGE_INIT_CHARGE_VOLTAGE3 ((CHARGE_DRV_ID<<16) | 13)
#define ITEM_CHARGE_PRECHARGE_ENABLE ((CHARGE_DRV_ID<<16) | 14)
#define ITEM_CHARGE_PRECHARGE_STOP_VOLTAGE ((CHARGE_DRV_ID<<16) | 15)
#define ITEM_CHARGE_PRECHARGE_CURRENT ((CHARGE_DRV_ID<<16) | 16)
#define ITEM_CHARGE_PRECHARGE_CURRENT_MIN_LIMIT ((CHARGE_DRV_ID<<16) | 17)
#define ITEM_CHARGE_FAST_CHARGE_ENABLE ((CHARGE_DRV_ID<<16) | 18)
#define ITEM_CHARGE_FAST_CHARGE_CURRENT ((CHARGE_DRV_ID<<16) | 19)
#define ITEM_CHARGE_FAST_CHARGE_VOLTAGE_THRESHOLD ((CHARGE_DRV_ID<<16) | 20)
#define ITEM_CHARGE_ENABLE_BATTERY_RECHARGE ((CHARGE_DRV_ID<<16) | 21)
#define ITEM_CHARGE_BATTERY_RECHARGE_THRESHOLD_LOWTEMP ((CHARGE_DRV_ID<<16) | 22)
#define ITEM_CHARGE_BATTERY_RECHARGE_THRESHOLD_NORTEMP ((CHARGE_DRV_ID<<16) | 23)
#define ITEM_CHARGE_BATTERY_RECHARGE_THRESHOLD_HIGHTEMP ((CHARGE_DRV_ID<<16) | 24)
#define ITEM_CHARGE_BATTERY_OVP_ENABLE ((CHARGE_DRV_ID<<16) | 25)
#define ITEM_CHARGE_BATTERY_OVP_VOLTAGE_LOWTEMP ((CHARGE_DRV_ID<<16) | 26)
#define ITEM_CHARGE_BATTERY_OVP_VOLTAGE_NORTEMP ((CHARGE_DRV_ID<<16) | 27)
#define ITEM_CHARGE_BATTERY_OVP_VOLTAGE_HIGHTEMP ((CHARGE_DRV_ID<<16) | 28)
#define ITEM_CHARGE_BATTERY_CHARGE_TOTAL_TIME_LIMIT ((CHARGE_DRV_ID<<16) | 29)
#define ITEM_CHARGE_BATTERY_CHECK_PERIOD_SEC	((CHARGE_DRV_ID<<16) | 30)
#define ITEM_CHARGE_CHECK_PERIOD_SEC	((CHARGE_DRV_ID<<16) | 31)
#define ITEM_CHARGE_FULL_CONTINUE_SEC	((CHARGE_DRV_ID<<16) | 32)
#define ITEM_CHARGE_FRONT_CHARGE_FULL_POWER_OFF_WAIT_SEC	((CHARGE_DRV_ID<<16) | 33)
#define ITEM_CHARGE_DC5V_DETECT_DEBOUNCE_TIME_MS	((CHARGE_DRV_ID<<16) | 34)
#define ITEM_CHARGE_BATTERY_DEFAULT_RDROP	((CHARGE_DRV_ID<<16) | 35)
#endif
...
/* BT Driver */
#define ITEM_BTC_LOG ((BTC_DRV_ID<<16) | 1)
#define ITEM_BTC_LOG_TX_PIN ((BTC_DRV_ID<<16) | 2)
#define ITEM_BTC_LOG_RX_PIN ((BTC_DRV_ID<<16) | 3)
#define ITEM_BTC_BQB_TX_PIN ((BTC_DRV_ID<<16) | 4)
#define ITEM_BTC_BQB_RX_PIN ((BTC_DRV_ID<<16) | 5)
#define ITEM_BTC_FIX_TX_POWER ((BTC_DRV_ID<<16) | 6)
#define ITEM_BTC_DEBUG_SIGNAL ((BTC_DRV_ID<<16) | 7)
