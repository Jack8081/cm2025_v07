...
#elif  defined(CONFIG_SOC_SERIES_CUCKOO) || defined(CONFIG_SOC_SERIES_CUCKOO_FPGA)
#include <drivers/cfg_drv/pinctrl_cuckoo.h>
#include <drivers/cfg_drv/dev_cuckoo.h>
#else
