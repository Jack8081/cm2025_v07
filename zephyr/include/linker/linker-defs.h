...
extern char _sleepfunc_ram_start[];
extern char _sleepfunc_ram_end[];
extern char _sleepfunc_ram_size[];
extern char _sleepfunc_rom_start[];
extern char __sleepnosave_ram_start[];
extern char __sleepnosave_ram_end[];
#else
