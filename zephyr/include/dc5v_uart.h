...
#else
#define DC5V_CTL_MFP_UART0TX        DC5V_CTL_MFP_SET(3)
#define DC5V_CTL_MFP_UART0RX        DC5V_CTL_MFP_SET(4)

#define SYSSET_UART_PWR_SEL         BIT(12)
#define SYSSET_UART_SW_SEL          BIT(10)

#define WKEN_CTL_DC5V_LHV_VOL_SHIFT    26
#define WKEN_CTL_DC5V_LHV_VOL_MASK     (0x07 << WKEN_CTL_DC5V_LHV_VOL_SHIFT)
#define WKEN_CTL_DC5VLV_WKEN_SHIFT     4
#define WKEN_CTL_DC5VLV_WKEN           BIT(4)
#endif
