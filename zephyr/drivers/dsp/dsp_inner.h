...
//#define CONFIG_SOFT_BREAKPOINT_DUMP_MEMORY
...
struct dsp_acts_config_entity {
	...
	/* dsp exported debug information through mailbox registers */
	uint32_t dsp_debuginfo[16];
	/* dsp function infos shared with cpu, completely allocated and used by the dsp */
	uint8_t dsp_function_infos[0x580];
};
