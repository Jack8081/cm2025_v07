...
#define PHY_CMD_GET_FIFO_WORKING                 (PHY_CMD_BASE + 21)
/*! Get fifo working state
 *  int phy_audio_control(dev, #PHY_CMD_GET_FIFO_WORKING, NULL)
 */

#define PHY_CMD_GET_ANTIPOP_STAGE                 (PHY_CMD_BASE + 22)
/*! Get antipop stage
 *  int phy_audio_control(dev, #PHY_CMD_GET_ANTIPOP_STAGE, void *param)
 */
...
#define PHY_CMD_ADC_FIFO_ENABLE            (PHY_CMD_ADC_BASE + 5)

 
 /*
 * enum antipop_stage_e
 * @brief antipop process stage.
 */
typedef enum {
