...
const cfg_key_map_t cfg_key_map_table[]={
	/* UART */
	...
	{ ITEM_ONOFF_PULLR_SEL, CFG_ONOFF_Key_Onoff_pullr_sel },
	...
	{ ITEM_AUDIO_MAIN_MIC, CFG_Audio_Settings_main_mic },
	{ ITEM_AUDIO_SUB_MIC, CFG_Audio_Settings_sub_mic },
	{ ITEM_AUDIO_ADC0_INPUT, CFG_Audio_Settings_adc0_input },
	{ ITEM_AUDIO_ADC1_INPUT, CFG_Audio_Settings_adc1_input },
	...
	{ ITEM_AUDIO_ANC_FF_MIC, CFG_Audio_Settings_anc_ff_mic },
	{ ITEM_AUDIO_ANC_FB_MIC, CFG_Audio_Settings_anc_fb_mic },
	{ ITEM_AUDIO_ADC2_INPUT, CFG_Audio_Settings_adc2_input },
    { ITEM_AUDIO_ADC3_INPUT, CFG_Audio_Settings_adc3_input },
    { ITEM_AUDIO_ADC2_SEL_VMIC, CFG_Audio_Settings_ADC2_SEL_VMIC },
    
    { ITEM_AUDIO_ANC_FF_GAIN_SETTING, CFG_Audio_Settings_ANC_FF_GAIN },
    { ITEM_AUDIO_ANC_FB_GAIN_SETTING, CFG_Audio_Settings_ANC_FB_GAIN },

    { ITEM_AUDIO_FF_AAL_ENABLE,  CFG_Audio_Settings_FF_AAL_Enable },
    { ITEM_AUDIO_FB_AAL_ENABLE,  CFG_Audio_Settings_FB_AAL_Enable },
    
    { ITEM_AUDIO_MAIN_MIC_AAL_VT1, CFG_Audio_Settings_MAIN_MIC_AAL_VT1 },
    { ITEM_AUDIO_MAIN_MIC_AAL_VT0, CFG_Audio_Settings_MAIN_MIC_AAL_VT0},

    { ITEM_AUDIO_ANC_FF_AAL_VT1, CFG_Audio_Settings_ANC_FF_AAL_VT1 },
    { ITEM_AUDIO_ANC_FF_AAL_VT0, CFG_Audio_Settings_ANC_FF_AAL_VT0},
    { ITEM_AUDIO_ANC_FB_AAL_VT1, CFG_Audio_Settings_ANC_FB_AAL_VT1 },
    { ITEM_AUDIO_ANC_FB_AAL_VT0, CFG_Audio_Settings_ANC_FB_AAL_VT0 },

    { ITEM_AUDIO_MAIN_MIC_AAL_ENABLE,  CFG_Audio_Settings_MAIN_MIC_AAL_Enable },
    { ITEM_AUDIO_SUB_MIC_AAL_ENABLE,   CFG_Audio_Settings_SUB_MIC_AAL_Enable },
#endif
    { ITEM_AUDIO_ADC0_SEL_VMIC, CFG_Audio_Settings_ADC0_SEL_VMIC },
    { ITEM_AUDIO_ADC1_SEL_VMIC, CFG_Audio_Settings_ADC1_SEL_VMIC },
	...
	{ ITEM_CHARGE_INIT_CHARGE_ENABLE, CFG_Battery_Charge_Init_Charge_Enable },
	{ ITEM_CHARGE_INIT_CHARGE_CURRENT1, CFG_Battery_Charge_Init_Charge_Current_1 },
	{ ITEM_CHARGE_INIT_CHARGE_VOLTAGE1, CFG_Battery_Charge_Init_Charge_Vol_1 },	
	{ ITEM_CHARGE_INIT_CHARGE_CURRENT2, CFG_Battery_Charge_Init_Charge_Current_2 },
	{ ITEM_CHARGE_INIT_CHARGE_VOLTAGE2, CFG_Battery_Charge_Init_Charge_Vol_2 },
	{ ITEM_CHARGE_INIT_CHARGE_CURRENT3, CFG_Battery_Charge_Init_Charge_Current_3 },
	{ ITEM_CHARGE_INIT_CHARGE_VOLTAGE3, CFG_Battery_Charge_Init_Charge_Vol_3 },
	{ ITEM_CHARGE_PRECHARGE_ENABLE, CFG_Battery_Charge_Precharge_Enable },
#endif
...
#else
	{ ITEM_CHARGE_BATTERY_RECHARGE_THRESHOLD_LOWTEMP, CFG_Battery_Charge_Recharge_Threshold_Low_Temperature },
	{ ITEM_CHARGE_BATTERY_RECHARGE_THRESHOLD_NORTEMP, CFG_Battery_Charge_Recharge_Threshold_Normal_Temperature },
	{ ITEM_CHARGE_BATTERY_RECHARGE_THRESHOLD_HIGHTEMP, CFG_Battery_Charge_Recharge_Threshold_High_Temperature },
	{ ITEM_CHARGE_BATTERY_OVP_ENABLE, CFG_Battery_Charge_Bat_OVP_Enable },
	{ ITEM_CHARGE_BATTERY_OVP_VOLTAGE_LOWTEMP, CFG_Battery_Charge_OVP_Voltage_Low_Temperature },
	{ ITEM_CHARGE_BATTERY_OVP_VOLTAGE_NORTEMP, CFG_Battery_Charge_OVP_Voltage_Normal_Temperature },
	{ ITEM_CHARGE_BATTERY_OVP_VOLTAGE_HIGHTEMP, CFG_Battery_Charge_OVP_Voltage_High_Temperature },
#endif
...
#ifdef CONFIG_SOC_SERIES_CUCKOO
	{ ITEM_CHARGE_BATTERY_DEFAULT_RDROP, CFG_Battery_Charge_Battery_Default_RDrop },
#endif
	...
	/* BTC Driver  */
	{ ITEM_BTC_LOG, CFG_BT_Debug_BTC_Log},
	{ ITEM_BTC_LOG_TX_PIN, CFG_BT_Debug_BTC_Log_TX_Pin},
	{ ITEM_BTC_LOG_RX_PIN, CFG_BT_Debug_BTC_Log_RX_Pin},
	{ ITEM_BTC_BQB_TX_PIN, CFG_BT_Debug_BTC_BQB_TX_Pin},
	{ ITEM_BTC_BQB_RX_PIN, CFG_BT_Debug_BTC_BQB_RX_Pin},
	{ ITEM_BTC_FIX_TX_POWER, CFG_BT_Debug_BTC_Fix_TX_Power},
	{ ITEM_BTC_DEBUG_SIGNAL, CFG_BT_Debug_BTC_Debug_Signal},
...
SYS_INIT(cfg_drv_init, PRE_KERNEL_1, 81);
