...
*******************************************************
**/
#define CHG_CTL_SVCC_CHG_TSTMODE 											(31)
#define      CHG_CTL_SVCC_OVCTLCHG 											(30)
#define      CHG_CTL_SVCC_BYPASS 											(29)
#define      CHG_CTL_SVCC_EN_CVLOOP                                         (28)
#define      CHG_CTL_SVCC_EN_CCLOOP                                         (27)
#define      CHG_CTL_SVCC_DC5VPD_S4_e                                       (26)
#define      CHG_CTL_SVCC_DC5VPD_S4_SHIFT                                   (25)
#define      CHG_CTL_SVCC_DC5VPD_S4_MASK                                    (0x3<<25)
#define      CHG_CTL_SVCC_DC5VPD_EN_e                       				(24)             
#define      CHG_CTL_SVCC_DC5VPD_EN_SHIFT                					(23)
#define      CHG_CTL_SVCC_DC5VPD_EN_MASK                                    (0x3<<23)
#define      CHG_CTL_SVCC_DC5VPD_SET_e                       				(22)
#define      CHG_CTL_SVCC_DC5VPD_SET_SHIFT                					(21)
#define      CHG_CTL_SVCC_DC5VPD_SET_MASK                                   (0x3<<21)
#define      CHG_CTL_SVCC_CV_3V3                                 			(19)
#define      CHG_CTL_SVCC_CHGOP_SEL                                      	(18)
#define      CHG_CTL_SVCC_BAT_PD_e                             				(17)
#define      CHG_CTL_SVCC_BAT_PD_SHIFT                     					(16)
#define      CHG_CTL_SVCC_BAT_PD_MASK                                       (0x3<<16)
#define      CHG_CTL_SVCC_CC_OFFSET_e                       				(15)
#define      CHG_CTL_SVCC_CC_OFFSET_SHIFT             						(11)
#define      CHG_CTL_SVCC_CC_OFFSET_MASK                                    (0x1F<<11)
#define      CHG_CTL_SVCC_CHG_EN                               				(10)
#define      CHG_CTL_SVCC_CV_OFFSET_e             							(9)
#define      CHG_CTL_SVCC_CV_OFFSET_SHIFT 									(5)
#define      CHG_CTL_SVCC_CV_OFFSET_MASK                                    (0x1F<<5)
#define      CHG_CTL_SVCC_CHG_CV_AD                         				(4)
#define      CHG_CTL_SVCC_CHG_CURRENT_e                  					(3)
#define      CHG_CTL_SVCC_CHG_CURRENT_SHIFT       							(0)
#define      CHG_CTL_SVCC_CHG_CURRENT_MASK                                  (0xF<<0)
...
enum CFG_TYPE_CHARGE_VOLTAGE
{
    ...
    CHARGE_VOLTAGE_4_40_V = 0x15,
    CHARGE_VOLTAGE_4_45_V = 0x19,
    CHARGE_VOLTAGE_4_475_V = 0x1B,
    CHARGE_VOLTAGE_4_50_V = 0x1D, 
};
...
#define BAT_CHARGE_CFG_DEFAULT { \
				...
				CHARGE_STOP_BY_VOLTAGE_AND_CURRENT, 4160, /*20*/CHARGE_STOP_CURRENT_20_MA, \
...
#define BAT_LEVEL_CFG_DEFAULT { \
				{3100, 3400, 3600, 3650, 3700, 3750, 3800, 3900, 3980, 4050}}
...
#define BAT_NTC_RANGE_1 { \
	0x0FAE, 0x13BF, 71, CHARGE_VOLTAGE_4_20_V, 60}
/*15-53*/
#define BAT_NTC_RANGE_2 { \
	0x14C0, 0x2258, 100, CHARGE_VOLTAGE_4_40_V, 240}
/*0-15 C*/
#define BAT_NTC_RANGE_3 { \
	0x2259, 0x2AE9, 57, CHARGE_VOLTAGE_4_40_V, 60}
/* < 0 */
...
extern uint8_t current_init_charge_stage1_NTC[5];
extern uint8_t current_init_charge_stage2_NTC[5];
extern uint8_t current_init_charge_stage3_NTC[5];
#endif
