...
extern char __sensor_algo_sram_start[];
extern char __sensor_algo_sram_end[];
#define __sensor_algo_sram_size	(__sensor_algo_sram_end - __sensor_algo_sram_start)
#define p_sensor_algo_sram_api	((const sensor_algo_api_t*)__sensor_algo_sram_start)
