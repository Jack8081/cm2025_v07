...
typedef enum {
	...
	/* audjust by asrc*/
	APS_LEVEL_ASRC,
	/* audjust by audio pll fractional-N*/
	APS_LEVEL_AUDIOPLL_F,
	APS_MODE_MAX,
} aps_level_mode_e;
...
typedef struct {
    ...
    uint8_t automute_force;   /*The automute force: 0:see CONFIG_AUDIO_DAC_0_AUTOMUTE; 1:automute force enable*/
...
int hal_aout_set_fifo_src(void *aout_channel_handle, uint8_t channel_id, bool from_dsp, void *dsp_audio_set_param, void *dsp_audio_handle);
