...
#define _sleepfunc_ram_start				Image$$ER_SLEEPFUNC$$Base
#define _sleepfunc_ram_end					Image$$ER_SLEEPFUNC$$Limit
#define _sleepfunc_ram_size					Image$$ER_SLEEPFUNC$$Length
#define _sleepfunc_rom_start				Load$$ER_SLEEPFUNC$$Base
#define __sleepnosave_ram_start             Image$$ER_SRAM_NOINIT$$Base
#define __sleepnosave_ram_end				Image$$ER_SRAM_NOINIT$$Limit
...
#define __wma_p_overlay_data_size					Image$$ER_WMA_P_OVERLAY_DATA$$Limit
