...
1.将lark_flash.FLM文件拷贝到keil安装目录，例如C:\Keil_v5\ARM\Flash
...
4.选择Flash Download标签页，在下面的Programming Algorithm中点击Add按钮，加载flash烧写算法lark_flash(注意检查文件路径为:C:\Keil_v5\ARM\flash\lark_flash.FLM)
