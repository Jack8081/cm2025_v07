...
#endif
{
	...
	printk("%s %d call addr:[%08x] \n", file,line, (unsigned int)__builtin_return_address(0));
#else
    printk("ASSERTION FAIL, call addr: [%08x] \n", (unsigned int)__builtin_return_address(0));
#endif
...
#ifdef CONFIG_ASSERT
#ifdef CONFIG_ASSERT_NO_FILE_INFO
void assert_post_action_for_rom(const char *file, unsigned int line)
{
