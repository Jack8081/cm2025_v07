...
const char* const __log_level_str[] = {
    "<?> ", "<E> ", "<W> ", "<I> ", "<D> "
};
...
static int _printk_ignore_flag = 0;
...
void __printk_set_null(int print_null)
{
	_printk_ignore_flag = print_null;
}

int __printk_get_null_flag(void)
{
	return _printk_ignore_flag;
}
