...
#define SPINOR_API_ADDR				(pbrom_api->p_spinor_api)
...
#define     PWRGATE_DIG                                                       (PMUVDD_BASE+0X1C)
#define     PWRGATE_DIG_ACK                                                   (PMUVDD_BASE+0X20)
#define     PWRGATE_RAM                                                       (PMUVDD_BASE+0X24)
#define     PWRGATE_RAM_ACK                                                   (PMUVDD_BASE+0X28)
#define     PMU_INTMASK                                                       (PMUVDD_BASE+0X2C)
...
//--------------Register Address---------------------------------------//
#define     DMAController_BASE                                                0x4001C000
#define     DMAIP                                                             (DMAController_BASE+0x00000000)
#define     DMAIE                                                             (DMAController_BASE+0x00000004)
#define     DMADEBUG                                                          (DMAController_BASE+0x00000080)
#define     DMAxCTL                                                           (DMAController_BASE+0x00000100)
#define     DMAxSTART                                                         (DMAController_BASE+0x00000104)
#define     DMAxSADDR0                                                        (DMAController_BASE+0x00000108)
#define     DMAxSADDR1                                                        (DMAController_BASE+0x0000010c)
#define     DMAxDADDR0                                                        (DMAController_BASE+0x00000110)
#define     DMAxDADDR1                                                        (DMAController_BASE+0x00000114)
#define     DMAxBC                                                            (DMAController_BASE+0x00000118)
#define     DMAxRC                                                            (DMAController_BASE+0x0000011c)

//--------------Register Address---------------------------------------//
#define     DAC_Control_Register_BASE                                         0x4005C000
#define     DAC_DAT_FIFO0                                                     (DAC_Control_Register_BASE+0x0C)

//--------------ADC_Control_Register-------------------------------------------//
//--------------Register Address---------------------------------------//
#define     ADC_Control_Register_BASE                                         0x4005C100
#define     ADC_FIFO0_DAT                                                     (ADC_Control_Register_BASE+0x14)
