...
/*10peq + drc(average of -0.5db & -12db)*/
const uint16_t postdae_run_mhz_dsp_music_2ch[4] = { 250, 250, 250, 250, };

/*10peq + drc(average of -0.5db & -12db)*/
const uint16_t postdae_run_mhz_dsp_music_1ch[4] = { 165, 165, 165, 165, };

/*7peq + drc*/
const uint16_t postdae_run_mhz_dsp_call_1ch[4] = { 115, 80, 80, 80, };

/*7peq + drc*/
const uint16_t predae_run_mhz_dsp_call_1ch[4] = { 95, 70, 70, 70, };

/*aec + dual mic ai enc*/
const uint16_t preaec_dual_mic_run_mhz_dsp_call_1ch[4] = { 500, 500, 500, 500 };

/*aec + single mic ai enc*/
const uint16_t preaec_single_mic_run_mhz_dsp_call_1ch[4] = { 200, 200, 200, 200 };

const uint16_t playback_system_run_mhz = 70;
const uint16_t capture_system_run_mhz = 80;
#endif
