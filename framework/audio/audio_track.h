 ...
 * @param sample_rate sample rate of track output 
 * @param format audio trace format 
 * @param audio_mode_and_audiopll_mode audio mode of track , mono or stereo
 ...
 */
#define AUDIO_MODE2_SHIFT    (0)      /* NOTE: Please don't modify it. */
#define AUDIO_MODE2_MASK     (0xf<<0) /* NOTE: Please don't modify it. */
#define AUDIOPLL_MODE_SHIFT  (7)
#define AUDIOPLL_MODE_MASK   (0x1<<7)
...
/**
 * @brief get audio track latency
 *
 * This routine get audio track latency in us
 *
 * @param handle handle of Track
 *
 * @return audio track latency
 */
...
/**
 * @brief set hardware left and right channnel enable
 *
 * This routine set hardware left and right channnel enable
 *
 * @param handle handle of Track
 * @param l_enable left channel enable or no
 * @param r_enable right channel enable or no
 *
 * @return 0 excute successed , others failed
 */
