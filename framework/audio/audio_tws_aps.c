...
static uint32_t _audio_get_samples_cnt(void *aps_monitor, uint8_t *audio_mode)
{
	...
	*audio_mode = handle->audio_track->channels;
...
void audio_aps_monitor_master(aps_monitor_info_t *handle, int stream_length_us, uint8_t aps_max_level, uint8_t aps_min_level, uint8_t aps_level)
{
...
void audio_aps_monitor_slave(aps_monitor_info_t *handle, int stream_length_us, uint8_t aps_max_level, uint8_t aps_min_level, uint8_t slave_aps_level)
{
	tws_runtime_observer_t *tws_observer = (tws_runtime_observer_t *)handle->tws_observer;
