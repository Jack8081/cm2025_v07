...
/**
 * @brief set system auto power off timeout time
 *
 * @details This routine set system  auto power off timeout time
 * @param timeout timeout time, The unit is s
 *
 * @return  N/A
 */
...
typedef void (*system_standby_notifier_t)(int);

/**
 * @brief register system standby event notifier
 *
 * @details This routine register system standby event notifier
 * @param notifier event notifier
 *
 * @return  0 success, none zero failed
 */
