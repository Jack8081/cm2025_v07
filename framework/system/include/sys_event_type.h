...
enum sys_event_e
{
    ...
    SYS_EVENT_NOMAL_MODE,
    SYS_EVENT_ANC_MODE,
    SYS_EVENT_TRANSPARENCY_MODE, 
    SYS_EVENT_ANC_LEISURE_MODE,
    SYS_EVENT_ANC_WIND_NOISE_MODE,

    SYS_EVENT_RING_HANDSET, 

    SYS_EVENT_XEAR_SURROUND_ON,
    SYS_EVENT_XEAR_SURROUND_OFF,
    SYS_EVENT_XEAR_NR_ON,
    SYS_EVENT_XEAR_NR_OFF,
