 ...
 */
#define _USB_AUDIO_MAX_VOL                 0xfff0 //0db
#define _USB_AUDIO_MIN_VOL                 0xe3a0 //-60db
#define _USB_AUDIO_VOL_STEP                0x0030
//#define _USB_AUDIO_MAX_VOL                 0x0000 //0db
//#define _USB_AUDIO_MIN_VOL                 0xC3D8 //-60db
//#define _USB_AUDIO_VOL_STEP                0x009A
#define _USB_AUDIO_MIC_MAX_VOL                 0xfff0 //0db
#define _USB_AUDIO_MIC_MIN_VOL                 0xe3a0 //-60db
#define _USB_AUDIO_MIC_VOL_STEP                0x0030
...
#define UAC_INPUT_TERMINAL_HEADSET              0x402
...
enum sync_info_type {
	...
	USOUND_SWITCH_TO_IOS,
	UMIC_SYNC_HOST_VOL_TYPE,
	UMIC_SYNC_HOST_MUTE,
	UMIC_SYNC_HOST_UNMUTE,
    USOUND_INCALL_RING,
    USOUND_INCALL_HOOK_UP,
    USOUND_INCALL_HOOK_HL,
    USOUND_INCALL_MUTE,
    USOUND_INCALL_UNMUTE,
    USOUND_INCALL_OUTGOING,
    USOUND_DEFINE_CMD_CONNECT_PAIRED_DEV,
};
...
/**
 * Callback function for call status.
 */
...
int usb_audio_composite_dev_init2(void);

/* flush USB audio device in/out endpoint FIFO */
...
/* register composite device volume sync callback */
...
/* Set the maximum, minimum and step of the volume before enumerating device */
...
int usb_audio_device_ep_read(uint8_t *data, uint32_t data_len, uint32_t *bytes_ret, uint8_t ep);
...
/* set sink source vol info */
void usb_audio_device_sink_set_vol_info(uint8_t vol_type, int vol_dat);

void usb_audio_device_source_set_vol_info(uint8_t vol_type, int vol_dat);

/* uac set sink source cur vol */
void usb_audio_device_sink_set_cur_vol(uint8_t channel_type, int vol_dat);
