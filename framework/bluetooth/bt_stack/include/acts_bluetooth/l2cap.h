...
struct bt_l2cap_chan {
    ...
    struct bt_l2cap_chan_opts *opts;
#endif
};
...
typedef void(*br_pending_rx_data_cb_t)(uint8_t *addr, struct net_buf *buf);
void bt_l2cap_br_reg_pending_rx_data_cb_func(br_pending_rx_data_cb_t cb);
void bt_l2cap_br_add_pending_rx_data(uint8_t *addr, uint8_t *data, uint16_t len);
