...
int bt_pacs_server_available_contexts_set(struct bt_pacs_server *srv,
				uint16_t source_aac, uint16_t sink_aac);

int bt_pacs_server_supported_contexts_set(struct bt_pacs_server *srv,
				uint16_t source_sac, uint16_t sink_sac);
