...
/** @def BT_UUID_MCS_VAL
 *  @brief Audio Media Control Service value
 */
#define BT_UUID_MCS_VAL 0x1848
/** @def BT_UUID_MCS
 *  @brief Audio Media Control Service
 */
#define BT_UUID_MCS \
	BT_UUID_DECLARE_16(BT_UUID_MCS_VAL)
/** @def BT_UUID_GMCS_VAL
 *  @brief Audio Generic Media Control Service value
 */
#define BT_UUID_GMCS_VAL 0x1849
/** @def BT_UUID_GMCS
 *  @brief Audio Generic Media Control Service
 */
#define BT_UUID_GMCS \
 ...
 */
#define BT_UUID_MCS_MEDIA_PLAYER_NAME_VAL 0x2b93
/** @def BT_UUID_MCS_MEDIA_PLAYER_NAME
 *  @brief Audio Media Control Service Media Player Name
 */
#define BT_UUID_MCS_MEDIA_PLAYER_NAME \
    BT_UUID_DECLARE_16(BT_UUID_MCS_MEDIA_PLAYER_NAME_VAL)
/** @def BT_UUID_MCS_MEDIA_PLAYER_ICON_OBJECT_ID_VAL
 *  @brief Audio Media Control Service Media Player Icon Object ID value
 */
#define BT_UUID_MCS_MEDIA_PLAYER_ICON_OBJECT_ID_VAL 0x2b94
/** @def BT_UUID_MCS_MEDIA_PLAYER_ICON_OBJ_ID
 *  @brief Audio Media Control Service Media Player Icon Object ID
 */
#define BT_UUID_MCS_MEDIA_PLAYER_ICON_OBJ_ID \
    BT_UUID_DECLARE_16(BT_UUID_MCS_MEDIA_PLAYER_ICON_OBJ_ID_VAL)
/** @def BT_UUID_MCS_MEDIA_PLAYER_ICON_URL_VAL
 *  @brief Audio Media Control Service Media Player Icon URL value
 */
#define BT_UUID_MCS_MEDIA_PLAYER_ICON_URL_VAL 0x2b95
/** @def BT_UUID_MCS_MEDIA_PLAYER_ICON_URL
 *  @brief Audio Media Control Service Media Player Icon URL
 */
#define BT_UUID_MCS_MEDIA_PLAYER_ICON_URL \
    BT_UUID_DECLARE_16(BT_UUID_MCS_MEDIA_PLAYER_ICON_URL_VAL)
/** @def BT_UUID_MCS_TRACK_CHANGED_VAL
 *  @brief Audio Media Control Service Track Changed value
 */
#define BT_UUID_MCS_TRACK_CHANGED_VAL 0x2b96
/** @def BT_UUID_MCS_TRACK_CHANGED
 *  @brief Audio Media Control Service Track Changed
 */
#define BT_UUID_MCS_TRACK_CHANGED \
    BT_UUID_DECLARE_16(BT_UUID_MCS_TRACK_CHANGED_VAL)
/** @def BT_UUID_MCS_TRACK_TITLE_VAL
 *  @brief Audio Media Control Service Track Title value
 */
#define BT_UUID_MCS_TRACK_TITLE_VAL 0x2b97
/** @def BT_UUID_MCS_TRACK_TITLE
 *  @brief Audio Media Control Service Track Title
 */
#define BT_UUID_MCS_TRACK_TITLE \
    BT_UUID_DECLARE_16(BT_UUID_MCS_TRACK_TITLE_VAL)
/** @def BT_UUID_MCS_TRACK_DURATION_VAL
 *  @brief Audio Media Control Service Track Duration value
 */
#define BT_UUID_MCS_TRACK_DURATION_VAL 0x2b98\
/** @def BT_UUID_MCS_TRACK_DURATION
 *  @brief Audio Media Control Service Track Duration
 */
#define BT_UUID_MCS_TRACK_DURATION \
    BT_UUID_DECLARE_16(BT_UUID_MCS_TRACK_DURATION_VAL)
/** @def BT_UUID_MCS_TRACK_POSITION_VAL
 *  @brief Audio Media Control Service Track Position value
 */
#define BT_UUID_MCS_TRACK_POSITION_VAL 0x2b99
/** @def BT_UUID_MCS_TRACK_POSITION
 *  @brief Audio Media Control Service Track Position
 */
#define BT_UUID_MCS_TRACK_POSITION \
    BT_UUID_DECLARE_16(BT_UUID_MCS_TRACK_POSITION_VAL)
/** @def BT_UUID_MCS_PLAYBACK_SPEED_VAL
 *  @brief Audio Media Control Service Playback Speed value
 */
#define BT_UUID_MCS_PLAYBACK_SPEED_VAL 0x2b9a
/** @def BT_UUID_MCS_PLAYBACK_SPEED
 *  @brief Audio Media Control Service Playback Speed
 */
#define BT_UUID_MCS_PLAYBACK_SPEED \
    BT_UUID_DECLARE_16(BT_UUID_MCS_PLAYBACK_SPEED_VAL)
/** @def BT_UUID_MCS_SEEKING_SPEED_VAL
 *  @brief Audio Media Control Service Seeking Speed value
 */
#define BT_UUID_MCS_SEEKING_SPEED_VAL 0x2b9b
/** @def BT_UUID_MCS_SEEKING_SPEED
 *  @brief Audio Media Control Service Seeking Speed
 */
#define BT_UUID_MCS_SEEKING_SPEED \
    BT_UUID_DECLARE_16(BT_UUID_MCS_SEEKING_SPEED_VAL)
/** @def BT_UUID_MCS_CURRENT_TRACK_SEGMENTS_OBJECT_ID_VAL
 *  @brief Audio Media Control Service Current Track Segments Object ID value
 */
#define BT_UUID_MCS_CURRENT_TRACK_SEGMENTS_OBJECT_ID_VAL 0x2b9c
/** @def BT_UUID_MCS_CURRENT_TRACK_SEGMENTS_OBJECT_ID
 *  @brief Audio Media Control Service Current Track Segments Object ID
 */
#define BT_UUID_MCS_CURRENT_TRACK_SEGMENTS_OBJECT_ID \
    BT_UUID_DECLARE_16(BT_UUID_MCS_CURRENT_TRACK_SEGMENTS_OBJECT_ID_VAL)
/** @def BT_UUID_MCS_CURRENT_TRACK_OBJECT_ID_VAL
 *  @brief Audio Media Control Service Current Track Object ID value
 */
#define BT_UUID_MCS_CURRENT_TRACK_OBJECT_ID_VAL 0x2b9d
/** @def BT_UUID_MCS_CURRENT_TRACK_OBJECT_ID
 *  @brief Audio Media Control Service Current Track Object ID
 */
#define BT_UUID_MCS_CURRENT_TRACK_OBJECT_ID \
    BT_UUID_DECLARE_16(BT_UUID_MCS_CURRENT_TRACK_OBJECT_ID_VAL)
/** @def BT_UUID_MCS_NEXT_TRACK_OBJECT_ID_VAL
 *  @brief Audio Media Control Service Next Track Object ID value
 */
#define BT_UUID_MCS_NEXT_TRACK_OBJECT_ID_VAL 0x2b9e
/** @def BT_UUID_MCS_NEXT_TRACK_OBJECT_ID
 *  @brief Audio Media Control Service Next Track Object ID
 */
#define BT_UUID_MCS_NEXT_TRACK_OBJECT_ID \
    BT_UUID_DECLARE_16(BT_UUID_MCS_NEXT_TRACK_OBJECT_ID_VAL)
/** @def BT_UUID_MCS_PARENT_GROUP_OBJECT_ID_VAL
 *  @brief Audio Media Control Service Parent Group Object ID value
 */
#define BT_UUID_MCS_PARENT_GROUP_OBJ_ID_VAL 0x2b9f
/** @def BT_UUID_MCS_PARENT_GROUP_OBJECT_ID
 *  @brief Audio Media Control Service Parent Group Object ID
 */
#define BT_UUID_MCS_PARENT_GROUP_OBJ_ID \
    BT_UUID_DECLARE_16(BT_UUID_MCS_PARENT_GROUP_OBJ_ID_VAL)
/** @def BT_UUID_MCS_CURRENT_GROUP_OBJECT_ID_VAL
 *  @brief Audio Media Control Service Current Group Object ID value
 */
#define BT_UUID_MCS_CURRENT_GROUP_OBJ_ID_VAL 0x2ba0
/** @def BT_UUID_MCS_CURRENT_GROUP_OBJECT_ID
 *  @brief Audio Media Control Service Current Group Object ID
 */
 ...
 *  @brief Audio Media Control Service Playing Order value
 */
#define BT_UUID_MCS_PLAYING_ORDER_VAL 0x2ba1
/** @def BT_UUID_MCS_PLAYING_ORDER
 *  @brief Audio Media Control Service Playing Order
 */
#define BT_UUID_MCS_PLAYING_ORDER \
    BT_UUID_DECLARE_16(BT_UUID_MCS_PLAYING_ORDER_VAL)
/** @def BT_UUID_MCS_PLAYING_ORDERS_SUPPORTED_VAL
 *  @brief Audio Media Control Service Playing Orders Supported value
 */
#define BT_UUID_MCS_PLAYING_ORDERS_SUPPORTED_VAL 0x2ba2
/** @def BT_UUID_MCS_PLAYING_ORDERS_SUPPORTED
 *  @brief Audio Media Control Service Playing Orders Supported
 */
#define BT_UUID_MCS_PLAYING_ORDERS_SUPPORTED \
    BT_UUID_DECLARE_16(BT_UUID_MCS_PLAYING_ORDERS_SUPPORTED_VAL)
/** @def BT_UUID_MCS_MEDIA_STATE_VAL
 *  @brief Audio Media Control Service Media State value
 */
#define BT_UUID_MCS_MEDIA_STATE_VAL 0x2ba3
/** @def BT_UUID_MCS_MEDIA_STATE
 *  @brief Audio Media Control Service Media State
 */
#define BT_UUID_MCS_MEDIA_STATE \
    BT_UUID_DECLARE_16(BT_UUID_MCS_MEDIA_STATE_VAL)
/** @def BT_UUID_MCS_MEDIA_CONTROL_POINT_VAL
 *  @brief Audio Media Control Service Media Control Point value
 */
#define BT_UUID_MCS_MEDIA_CONTROL_POINT_VAL 0x2ba4
/** @def BT_UUID_MCS_MEDIA_CONTROL_POINT
 *  @brief Audio Media Control Service Media Control Point
 */
#define BT_UUID_MCS_MEDIA_CONTROL_POINT \
    BT_UUID_DECLARE_16(BT_UUID_MCS_MEDIA_CONTROL_POINT_VAL)
/** @def BT_UUID_MCS_MEDIA_CONTROL_POINT_OPCODES_SUPPORTED_VAL
 *  @brief Audio Media Control Service Media Control Point Opcodes Supported value
 */
#define BT_UUID_MCS_MEDIA_CONTROL_POINT_OPCODES_SUPPORTED_VAL 0x2ba5
/** @def BT_UUID_MCS_MEDIA_CONTROL_POINT_OPCODES_SUPPORTED
 *  @brief Audio Media Control Service Media Control Point Opcodes Supported
 */
#define BT_UUID_MCS_MEDIA_CONTROL_POINT_OPCODES_SUPPORTED \
    BT_UUID_DECLARE_16(BT_UUID_MCS_MEDIA_CONTROL_POINT_OPCODES_SUPPORTED_VAL)
/** @def BT_UUID_MCS_SEARCH_RESULTS_OBJECT_ID_VAL
 *  @brief Audio Media Control Service Search Result Object ID value
 */
#define BT_UUID_MCS_SEARCH_RES_OBJ_ID_VAL 0x2ba6
/** @def BT_UUID_MCS_SEARCH_RESULTS_OBJECT_ID
 *  @brief Audio Media Control Service Search Result Object ID
 */
#define BT_UUID_MCS_SEARCH_RES_OBJ_ID \
    BT_UUID_DECLARE_16(BT_UUID_MCS_SEARCH_RES_OBJ_ID_VAL)
/** @def BT_UUID_MCS_SEARCH_CONTROL_POINT_VAL
 *  @brief Audio Media Control Service Search Control Point value
 */
#define BT_UUID_MCS_SEARCH_CONTROL_POINT_VAL 0x2ba7
/** @def BT_UUID_MCS_SEARCH_CONTROL_POINT
 *  @brief Audio Media Control Service Search Control Point
 */
#define BT_UUID_MCS_SEARCH_CONTROL_POINT \
    BT_UUID_DECLARE_16(BT_UUID_MCS_SEARCH_CONTROL_POINT_VAL)
/** @def BT_UUID_MCS_CONTENT_CONTROL_ID_VAL
 *  @brief Audio Media Control Service Content Control ID value
 */
#define BT_UUID_CONTENT_CONTROL_ID_VAL 0x2bba
/** @def BT_UUID_MCS_CONTENT_CONTROL_ID
 *  @brief Audio Media Control Service Content Control ID
 */
#define BT_UUID_CONTENT_CONTROL_ID \
    BT_UUID_DECLARE_16(BT_UUID_CONTENT_CONTROL_ID_VAL)
