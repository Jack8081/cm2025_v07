...
enum {
	DID_TYPE_ACTIONS_COMPANY_ID,
	DID_TYPE_DEFAULT_COMPANY_ID,
	DID_TYPE_PRODUCT_ID,
	DID_TYPE_VERSION,
};
...
struct bt_dev {
    ...
    struct bt_le_ext_adv    adv_legacy;
#endif
...
//#endif
	...
	bt_addr_t ctrl_active_connect_addr;

	/* For snoop tws dev used share bluetooth address */
	uint8_t share_db_addr_valid:1;
	bt_addr_t share_db_addr;
