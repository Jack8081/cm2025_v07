...
#define BT_CONFIG_HFP_FEATURE_ECS 0
#define BT_CONFIG_HFP_FEATURE_ECC 0
#else
#define BT_CONFIG_HFP_HFFEATURE_ESCO_S4 0
#define BT_CONFIG_HFP_FEATURE_ECS BT_HFP_HF_FEATURE_ECS
#define BT_CONFIG_HFP_FEATURE_ECC BT_HFP_HF_FEATURE_ECC
#endif
...
#define BT_HFP_AG_SUPPORTED_FEATURES_PTS    (\
						BT_HFP_AG_FEATURE_ECS | \
						BT_HFP_AG_FEATURE_EXT_ERR | \
						BT_HFP_AG_INBAND_RING_TONE | \
                        BT_HFP_AG_FEATURE_ESCO_S4\
						)
#endif
...
struct bt_hfp_ag {
    ...
    u8_t ag_ind_actived;
    u8_t tr_ag_pend_cnt;
    u8_t tr_ag_pend_try_cnt;
    sys_slist_t  tr_ag_pend_list;
    struct k_delayed_work tr_ag_pend_work;
#endif
...
/***********************   Sync info  ******************************/
bool bt_hfp_hf_ready_sync_info(struct bt_conn *conn);
int bt_hfp_hf_get_sync_info(struct bt_conn *conn, void *info);
int bt_hfp_hf_set_sync_info(struct bt_conn *conn, void *info);
void bt_hfp_hf_dump_info(void);
