...
#define BT_AVDTP_ERR_NOT_INVALID_LAYER                       0xCF

#define BT_AVDTP_ERR_INVALID_OBJECT_TYPE                     0xD6
#define BT_AVDTP_ERR_NOT_SUPPORTED_OBJECT_TYPE               0xD7
#define BT_AVDTP_ERR_INVALID_CHANNELS                        0xD8
#define BT_AVDTP_ERR_NOT_SUPPORTED_CHANNELS                  0xD9
...
#define BT_AVDTP_ERR_INVALID_DRC                             0xE4
#define BT_AVDTP_ERR_NOT_SUPPORTED_DRC                       0xE5
...
int bt_avdtp_set_sync_info_create(struct bt_avdtp_conn *pAvdtp_conn);
