...
static void provider_ccc_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}

static void technology_ccc_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}

static void schemes_ccc_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}

static void strength_ccc_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}

static void calls_ccc_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}
...
#else
static void target_ccc_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}
#endif

static void state_ccc_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}

static void control_ccc_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}

static void reason_ccc_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}

static void call_ccc_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}
...
#ifdef CONFIG_LE_AUDIO_SR_BQB
#else
static void friendly_ccc_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}
#endif
