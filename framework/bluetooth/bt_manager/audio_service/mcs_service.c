...
static void mcs_media_player_name_cfg_changed(const struct bt_gatt_attr *attr,
				   uint16_t value)
{
	printk("value 0x%04x\n", value);
}

static void mcs_track_changed_cfg_changed(const struct bt_gatt_attr *attr,
				   uint16_t value)
{
	printk("value 0x%04x\n", value);
}

static void mcs_media_state_cfg_changed(const struct bt_gatt_attr *attr,
				   uint16_t value)
{
	printk("value 0x%04x\n", value);
}

static void mcs_track_title_cfg_changed(const struct bt_gatt_attr *attr,
				   uint16_t value)
{
	printk("value 0x%04x\n", value);
}

static void mcs_track_duration_cfg_changed(const struct bt_gatt_attr *attr,
				   uint16_t value)
{
	printk("value 0x%04x\n", value);
}

static void mcs_track_position_cfg_changed(const struct bt_gatt_attr *attr,
				   uint16_t value)
{
	printk("value 0x%04x\n", value);
}

static void mcs_playback_speed_cfg_changed(const struct bt_gatt_attr *attr,
				   uint16_t value)
{
	printk("value 0x%04x\n", value);
}

static void mcs_media_control_point_cfg_changed(const struct bt_gatt_attr *attr,
				   uint16_t value)
{
	printk("value 0x%04x\n", value);
}

static void mcs_opcodes_supported_cfg_changed(const struct bt_gatt_attr *attr,
				   uint16_t value)
{
	printk("value 0x%04x\n", value);
}
