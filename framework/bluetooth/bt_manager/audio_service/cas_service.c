...
static void cas_sirk_ccc_cfg_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}

static void cas_size_ccc_cfg_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}

static void cas_lock_ccc_cfg_changed(const struct bt_gatt_attr *attr,
				uint16_t value)
{
}
