...
typedef struct
{
    unsigned char  leaudio_enable:1;   // 启用 LEAUDIO 功能
	unsigned char  app_auto_switch:1;  //启用BR music与LEA 场景自动切换功能
	unsigned char  leaudio_dir_adv_enable:1;  //启用定向广播
} btmgr_leaudio_cfg_t;
...
#ifdef CONFIG_BT_TRANSCEIVER
#include "tr_bt_manager_config.h"
#endif
